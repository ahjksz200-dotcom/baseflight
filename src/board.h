...
#if defined(NAZE)
// Afroflight32 - Optimized for Blue Pill

#define LED0_GPIO   GPIOC
#define LED0_PIN    Pin_13 // LED mặc định của Blue Pill (PC13)
#define LED1_GPIO   GPIOC
#define LED1_PIN    Pin_13 // Ép LED1 dùng chung chân PC13 để tránh lỗi driver gọi LED1

#define BEEP_GPIO   GPIOA
#define BEEP_PIN    Pin_15 // Chuyển Buzzer sang PA15 (để giải phóng PA12 cho USB)

#define BARO_GPIO   GPIOB
#define BARO_PIN    Pin_2  // Chuyển Baro sang PB2 (tránh PC13 của LED)

// Giữ nguyên các định nghĩa tính năng
#define GYRO
#define ACC
#define MAG
#define BARO
...
#define LED0
#define LED1
// #define INVERTER // Blue Pill không có mạch Inverter rời như Naze32, nên tắt đi nếu không cần
#define MOTOR_PWM_RATE 400

#define SENSORS_SET (SENSOR_ACC | SENSOR_BARO | SENSOR_MAG)
#define I2C_DEVICE (I2CDEV_2) // I2C2: SCL=PB10, SDA=PB11
